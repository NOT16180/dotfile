-- Configuration rustaceanvim (DOIT être avant le chargement des plugins)
vim.g.rustaceanvim = {
    server = {
        cmd = { "/home/not/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/bin/rust-analyzer" },
        -- Ou utilisez rustup si vous préférez:
...
vim.opt.shiftwidth = 4 -- Largeur d'un niveau d'indentation
vim.opt.expandtab = false -- Convertit les tabulations en espaces
vim.opt.softtabstop = 4 -- Nombre d'espaces à insérer/supprimer avec Tab/Backspace
